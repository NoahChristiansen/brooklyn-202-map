...
popup = GeoJsonPopup(
    fields=['property_name_text', 'property_total_unit_count'],
    aliases=['Property Name ', 'Total Unit Count\n'],
    localize=True,
    labels=True,
...
tooltip = GeoJsonTooltip(
    fields=['property_name_text', 'property_total_unit_count', 'owner_organization_name',
    ...
    aliases=['Property Name', 'Total Unit Count ', 'Owner Organization ',
            'Sponsor', 'Natural Gas Use (kBtu) ', 'Electricity Use - Grid Purchase (kWh) ','LL84 Total GHG Emissions (MTCO2e) ', 'Energy Star Score ',
            'Site Energy Unit Intensity (EUI) (kBtu/sqft) '],
    localize=True,
    sticky=False,
